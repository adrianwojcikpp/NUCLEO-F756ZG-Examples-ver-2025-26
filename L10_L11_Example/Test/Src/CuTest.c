/**
  ...
  * @version  : 1.0.0
  * @date     : Nov 6, 2025
  * @brief    : Minimal unit testing framework for C — CuTest implementation file.
  *
  *             This file contains the implementation of CuStr and CuString
  *             helper functions used in the CuTest framework.
  *
  * @see      : https://github.com/ennorehling/cutest/blob/master/CuTest.c
  *
  ********************************************************************************
  */
#ifdef _MSC_VER
